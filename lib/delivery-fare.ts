...
export const PACKAGE_SIZES = [
  { id: 'document', label: '서류/소형', hint: '서류봉투/소형 상자' },
  { id: 'small', label: '중소형', hint: '소형 박스' },
  { id: 'medium', label: '중형', hint: '일반 박스' },
  { id: 'large', label: '중대형', hint: '대형 박스' },
  { id: 'xlarge', label: '대형/특대형', hint: '특대형 화물' },
] as const
